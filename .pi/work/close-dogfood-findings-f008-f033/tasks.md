...
- [x] Profile and budget session/new and startupInfo.
- [x] Replace routine absolute paths with portable labels/counts.
- [x] Add stale-build/fresh-chat evidence and reconcile implemented findings.
...
- [x] Add deterministic cancellation and late-update rejection.
- [x] Add new/list/load/replay/delete/idempotence and invalid-request lanes.
- [x] Isolate state in temporary `PI_CODING_AGENT_DIR` and assert cleanup.
...
- [x] Exercise non-empty authenticated descriptors and safe invocation.
- [x] Prove bridge cancellation/cleanup and nested redaction.
- [x] Persist list-change and conditional debugger guidance.
...
- [x] Centralize configured Pi command/package resolution.
- [x] Validate smoke classification, reachability, and deadline ownership.
- [x] Add Node 20/current CI and generalize metadata.
...
- [x] Emit versioned redacted JSON and Markdown reports.
- [x] Add bounded fresh-JetBrains acceptance/unavailable recording.
- [x] Reconcile every finding and run all gates plus independent review.
